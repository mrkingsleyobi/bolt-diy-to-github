...
// Mock module import to avoid initialization issues
jest.mock('../../../src/chrome-extension/content/content.js', () => {
  // We need to dynamically import the functions after setting up mocks
  const actual = jest.requireActual('../../../src/chrome-extension/content/content.js');
  return {
    ...actual,
...
describe('Bolt.DIY to GitHub Content Script', () => {
  ...
  describe('isBoltDiyProjectPage', () => {
    ...
    it('should detect Bolt.DIY app page by URL pattern', () => {
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/app/my-app'
        },
        writable: true
      });
    ...
    it('should detect project page by data attributes', () => {
      mockDocument.querySelectorAll.mockReturnValue([{ getAttribute: () => '12345' }]);
    ...
    it('should return false for non-Bolt.DIY pages', () => {
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://example.com/project/12345'
        },
        writable: true
      });
  ...
  describe('isBoltDiyExportPage', () => {
    it('should detect export page by URL pattern', () => {
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/project/12345/export'
        },
        writable: true
      });
    ...
    it('should detect download page by URL pattern', () => {
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/download/my-project'
        },
        writable: true
      });
    ...
    it('should detect sync page by URL pattern', () => {
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/project/12345/sync'
        },
        writable: true
      });
    ...
    it('should detect export page with query parameters', () => {
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/export/12345?format=zip'
        },
        writable: true
      });
    ...
    it('should handle text content detection for export buttons', () => {
      // This test covers functionality in monitorExportTriggers but we're testing the detection logic
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/project/12345'
        },
  ...
  describe('extractProjectId', () => {
    it('should extract project ID from URL', () => {
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/project/abc123',
          hostname: 'bolt.diy',
    ...
    it('should generate fallback project ID', () => {
      ...
      // With our improved fallback, it should be at least some reasonable length
  ...
  describe('extractProjectName', () => {
    ...
    it('should extract project name from h1 elements', () => {
      Object.defineProperty(document, 'title', {
        value: 'Bolt.DIY - Project Platform',
        writable: true
      });

      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === 'h1') {
          return [{ textContent: 'My Project Title' }];
        }
        return [];
      });
    ...
    it('should use fallback project name', () => {
      ...
      Object.defineProperty(window, 'location', {
        value: {
          href: 'https://bolt.diy/project/test123',
          hostname: 'bolt.diy',
          pathname: '/project/test123'
        },
        writable: true
      });
    ...
    it('should prioritize title over h1 elements', () => {
      Object.defineProperty(document, 'title', {
        value: 'Title Project Name - Bolt.DIY',
        writable: true
      });

      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === 'h1') {
          return [{ textContent: 'H1 Project Title' }];
        }
        return [];
      });
  ...
  describe('extractProjectDescription', () => {
    ...
    it('should extract description from paragraph elements', () => {
      ...
      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === 'p') {
          return [{ textContent: 'This is a detailed project description that explains what the project does.' }];
        }
        return [];
      });
    ...
    it('should prioritize meta description over paragraph content', () => {
      ...
      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === 'p') {
          return [{ textContent: 'Paragraph description content' }];
        }
        return [];
      });
  ...
  describe('extractDependencies', () => {
    ...
    it('should extract dependencies from JSON data', () => {
      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === '[data-dependencies], [class*="dependencies"], [id*="dependencies"]') {
          return [{ textContent: '{"dependencies": {"react": "^18.0.0"}, "devDependencies": {"@types/react": "^18.0.0"}}' }];
        }
        return [];
      });
    ...
    it('should merge dependencies from multiple sources', () => {
      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === '[data-dependencies], [class*="dependencies"], [id*="dependencies"]') {
          return [{ textContent: '{"dependencies": {"react": "^18.0.0"}}' }];
        }
        return [];
      });
    ...
    it('should prioritize JSON dependencies over detected libraries', () => {
      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === '[data-dependencies], [class*="dependencies"], [id*="dependencies"]') {
          return [{ textContent: '{"dependencies": {"custom-react": "^1.0.0"}}' }];
        }
        return [];
      });
  ...
  describe('extractEnvironmentConfig', () => {
    ...
    it('should extract environment configuration from JSON data', () => {
      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === '[data-env], [class*="env"], [id*="env"]') {
          return [{ textContent: '{"development": {"API_URL": "http://localhost:3000"}}' }];
        }
        return [];
      });
    ...
    it('should merge environment configurations from multiple sources', () => {
      mockDocument.querySelectorAll.mockImplementation((selector) => {
        if (selector === '[data-env], [class*="env"], [id*="env"]') {
          return [{ textContent: '{"staging": {"API_URL": "https://staging.example.com"}}' }];
        }
        if (selector === '[data-env-var]') {
          return [{
            getAttribute: (attr: string) => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle malformed URLs gracefully', () => {
      // Set up malformed URL using the same approach as the working test
      mockDocument.location.href = 'invalid-url';
      mockDocument.location.hostname = '';
    ...
    it('should handle window.btoa errors gracefully', () => {
      // Mock btoa to throw an error using the same approach as working test
      mockWindow.btoa = () => {
        throw new Error('btoa not supported');
      };

      // Set up location using the same approach as working test
