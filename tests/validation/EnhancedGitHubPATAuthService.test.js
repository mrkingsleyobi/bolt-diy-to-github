...
describe('EnhancedGitHubPATAuthService', () => {
    ...
    const validFineGrainedToken = 'github_pat_abcdefghijklmnopqrstuvwxyzABCDEFGH0123456789abcdefghij';
    ...
    describe('validateTokenFormat', () => {
        ...
        it('should return false for null or undefined tokens', () => {
            expect(authService.validateTokenFormat(null)).toBe(false);
            expect(authService.validateTokenFormat(undefined)).toBe(false);
        });
        it('should return false for non-string tokens', () => {
            expect(authService.validateTokenFormat(123)).toBe(false);
    ...
    describe('validateTokenWithAPI', () => {
        ...
        it('should validate successfully with a valid token', async () => {
            ...
            const result = await authService.validateTokenWithAPI(validClassicToken);
        ...
        it('should handle invalid token during validation', async () => {
            const result = await authService.validateTokenWithAPI(invalidToken);
            expect(result).toEqual({
                valid: false,
        ...
        it('should handle missing token during validation', async () => {
            const result = await authService.validateTokenWithAPI('');
            expect(result).toEqual({
                valid: false,
    ...
    describe('authenticate', () => {
        ...
        it('should authenticate successfully with a valid token', async () => {
            ...
            const result = await authService.authenticate(validClassicToken);
            expect(result).toEqual({
                authenticated: true,
                user: mockUser
            });
    ...
    describe('authenticateWithStoredToken', () => {
        ...
        it('should authenticate successfully with a stored token', async () => {
            ...
            const result = await authService.authenticateWithStoredToken(key);
            expect(result).toEqual({
                authenticated: true,
                user: mockUser
            });
        ...
        it('should handle authentication failure with non-existent stored token', async () => {
            const result = await authService.authenticateWithStoredToken('non-existent-key');
            expect(result).toEqual({
                authenticated: false,
