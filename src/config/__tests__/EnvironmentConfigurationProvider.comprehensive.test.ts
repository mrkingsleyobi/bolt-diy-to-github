...
describe('EnvironmentConfigurationProvider - Comprehensive Tests', () => {
  ...
  beforeEach(() => {
    ...
    provider = new EnvironmentConfigurationProvider('test-env-provider', 'TEST_');
  });
  ...
  describe('Constructor and Basic Functionality', () => {
    it('should create instance with name and prefix', () => {
      const providerWithPrefix = new EnvironmentConfigurationProvider('test-provider', 'TEST_');
      expect(providerWithPrefix.getName()).toBe('test-provider');

      const providerWithoutPrefix = new EnvironmentConfigurationProvider('test-provider');
