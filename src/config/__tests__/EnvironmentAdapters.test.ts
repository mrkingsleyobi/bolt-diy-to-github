...
import { CloudEnvironmentAdapter } from '../adapters/CloudEnvironmentAdapter';
import { CICDEnvironmentAdapter } from '../adapters/CICDEnvironmentAdapter';
import { EnvironmentType } from '../EnvironmentAdapter';
