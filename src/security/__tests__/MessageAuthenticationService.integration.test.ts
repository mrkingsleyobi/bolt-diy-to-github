...
describe('MessageAuthenticationService - Integration Test', () => {
  ...
  let extensionAuthService: MessageAuthenticationService;

  // Simulate bolt.diy platform side
  let platformAuthService: MessageAuthenticationService;

  beforeEach(() => {
    jest.useFakeTimers();

    // Initialize extension-side service
    extensionAuthService = new MessageAuthenticationService();
    extensionAuthService.setSecretKey(SHARED_SECRET_KEY);

    // Initialize platform-side service
    platformAuthService = new MessageAuthenticationService();
  ...
  it('should demonstrate complete cross-origin communication flow', () => {
    ...
    const transmittedMessage: SignedMessage = {
    ...
    const transmittedResponse: SignedMessage = {
  ...
  it('should reject messages from attacker with different key', () => {
    ...
    const attackerAuthService = new MessageAuthenticationService();
    ...
    const fakeSignedMessage: SignedMessage = {
