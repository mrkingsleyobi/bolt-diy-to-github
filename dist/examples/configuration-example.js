"use strict";
// configuration-example.ts - Example usage of the configuration management system
Object.defineProperty(exports, "__esModule", { value: true });
exports.configurationExample = configurationExample;
const BasicConfigurationManager_1 = require("../config/BasicConfigurationManager");
...
async function configurationExample() {
    ...
    const authenticationService = new MessageAuthenticationService_1.MessageAuthenticationService();
    authenticationService.setSecretKey('example-secret-key-for-demo');
    // Create configuration manager
    const configManager = new BasicConfigurationManager_1.BasicConfigurationManager(encryptionService, authenticationService);
    try {
        ...
        const validator = new ConfigValidator_1.ConfigValidatorImpl();
...
//# sourceMappingURL=configuration-example.js.map