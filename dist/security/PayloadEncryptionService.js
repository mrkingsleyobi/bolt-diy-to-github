...
exports.PayloadEncryptionService = void 0;
...
class PayloadEncryptionService {
     ...
     */
    async encryptPayload(payload, secret) {
        // Validate inputs
     ...
     */
    async decryptPayload(encryptedMessage, secret) {
        // Validate inputs
        if (!encryptedMessage) {
...
exports.PayloadEncryptionService = PayloadEncryptionService;
//# sourceMappingURL=PayloadEncryptionService.js.map