...
describe('PayloadEncryptionService', () => {
    ...
    it('should reject decryption with invalid encrypted message', async () => {
        await expect(service.decryptPayload(null, testSecret))
            .rejects.toThrow('Encrypted message is required');
        await expect(service.decryptPayload(undefined, testSecret))
            .rejects.toThrow('Encrypted message is required');
    });
...
//# sourceMappingURL=PayloadEncryptionService.london.tdd.test.js.map