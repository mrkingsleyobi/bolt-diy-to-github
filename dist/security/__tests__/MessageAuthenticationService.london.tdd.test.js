...
describe('MessageAuthenticationService', () => {
    ...
    it('should throw error when signing without secret key', () => {
        const serviceWithoutKey = new MessageAuthenticationService_1.MessageAuthenticationService();
        expect(() => {
...
//# sourceMappingURL=MessageAuthenticationService.london.tdd.test.js.map