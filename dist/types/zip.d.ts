...
export declare class ZipExtractionError extends Error {
    readonly code: 'INVALID_ZIP_FILE' | 'CORRUPTED_ZIP_FILE' | 'FILE_TOO_LARGE' | 'EXTRACTION_FAILED' | 'UNSUPPORTED_FORMAT' | 'STREAM_ERROR' | 'MEMORY_LIMIT_EXCEEDED';
    readonly originalError?: Error | undefined;
    constructor(message: string, code: 'INVALID_ZIP_FILE' | 'CORRUPTED_ZIP_FILE' | 'FILE_TOO_LARGE' | 'EXTRACTION_FAILED' | 'UNSUPPORTED_FORMAT' | 'STREAM_ERROR' | 'MEMORY_LIMIT_EXCEEDED', originalError?: Error | undefined);
}
