...
describe('EnvironmentConfigurationService - Integration Tests', () => {
    ...
    let messageAuthenticationService;
    ...
    beforeEach(() => {
        ...
        messageAuthenticationService = new MessageAuthenticationService_1.MessageAuthenticationService();
        ...
        githubAppAuthService = new GitHubAppAuthService_1.GitHubAppAuthService();
        // Create service with real dependencies
        service = new EnvironmentConfigurationService_1.EnvironmentConfigurationService(tokenEncryptionService, messageAuthenticationService, tokenEncryptionService, // Reuse for token encryption
        testEncryptionPassword, githubPatAuthService, githubAppAuthService);
    });
    afterEach(() => {
    ...
    describe('Token Encryption and Validation Flow', () => {
        ...
        it('should validate GitHub PAT format correctly', () => {
            ...
            expect(githubPatAuthService.validateToken(null)).toBe(false);
        });
    });
    ...
    describe('Performance and Scalability', () => {
        it('should handle configuration of reasonable size efficiently', async () => {
            ...
            expect(Object.keys(largeConfig.features)).toHaveLength(100);
            expect(Object.keys(largeConfig.settings)).toHaveLength(50);
        });
...
//# sourceMappingURL=EnvironmentConfigurationService.integration.test.js.map