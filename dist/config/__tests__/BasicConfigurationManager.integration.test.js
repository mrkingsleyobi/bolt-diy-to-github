...
describe('BasicConfigurationManager - Integration Tests', () => {
    ...
    beforeEach(() => {
        ...
        authenticationService = new MessageAuthenticationService_1.MessageAuthenticationService();
        authenticationService.setSecretKey('test-secret');
        manager = new BasicConfigurationManager_1.BasicConfigurationManager(encryptionService, authenticationService);
    });
    afterEach(() => {
    ...
    describe('Complete Configuration Lifecycle', () => {
        ...
        it('should maintain configuration consistency across operations', async () => {
            ...
            const verifyNestedValue = (obj, prefix = '') => {
                Object.entries(obj).forEach(([key, value]) => {
                    const fullKey = prefix ? `${prefix}.${key}` : key;
                    if (typeof value === 'object' && value !== null && !Array.isArray(value)) {
...
//# sourceMappingURL=BasicConfigurationManager.integration.test.js.map